...
router.route(`/:id/2FA/Validate`).post(authController.validate2FA);

// AFTER LOGGING IN
router.route(`/:id`).get(authController.login).post(authController.login);
router.route('/:id/Me').get(authController.protect, userController.getMe).post(userController.getMe);
...
router.route(`/:id/2FA`).post(authController.protect, authController.setup2FA);
router.route(`/:id/2FA/Verify`).post(authController.protect, authController.verify2FA);
